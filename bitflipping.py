...
class bitfliping_attack(object):
    ...
    def nwkserver(self,nwkskey,phypayload):
        ...
        if mic_cal.upper() == mic:
            ...
            print '[Network Server]: Signature error'
        return msg
...
if plaintext == plaintext_cal:
    ...
    print  '[Application server]: Message is not the same. Received',plaintext_cal2,'. Mote sent',binascii.a2b_hex(plaintext)
